...
// basic_object_construction - function:parse function:expand_dotted function:build_hierarchy (level 1)
...
// single_nested_object - function:parse function:expand_dotted function:build_hierarchy (level 1)
...
// deep_nested_objects - function:parse function:expand_dotted function:build_hierarchy (level 1)
...
// duplicate_keys_to_lists - function:parse function:expand_dotted function:build_hierarchy (level 1)
...
// nested_duplicate_keys - function:parse function:expand_dotted function:build_hierarchy (level 1)
...
// mixed_flat_and_nested - function:parse function:expand_dotted function:build_hierarchy (level 1)
...
// nested_objects_with_lists - function:parse function:expand_dotted function:build_hierarchy (level 1)
