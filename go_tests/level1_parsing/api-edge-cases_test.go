...
// indented_key - feature:whitespace function:parse_value (level 2)
...
// key_empty_value - feature:empty_keys function:parse (level 1)
...
// empty_value_with_newline - feature:empty_keys function:parse (level 1)
...
// empty_value_with_spaces - feature:empty_keys feature:whitespace function:parse (level 1)
...
// empty_key_indented - feature:empty_keys function:parse_value (level 2)
...
// empty_key_with_newline - feature:empty_keys function:parse (level 1)
...
// empty_key_value_with_spaces - feature:empty_keys feature:whitespace function:parse (level 1)
...
// key_with_tabs - behavior:tabs_preserve feature:whitespace function:parse variant:proposed_behavior (level 1)
...
// key_with_tabs_ocaml_reference - behavior:tabs_preserve feature:whitespace function:parse variant:reference_compliant (level 1)
...
// whitespace_only_value - feature:empty_keys feature:whitespace function:parse (level 1)
...
// spaces_vs_tabs_continuation - behavior:tabs_preserve feature:whitespace function:parse_value variant:proposed_behavior (level 2)
...
// spaces_vs_tabs_continuation_ocaml_reference - behavior:tabs_preserve feature:whitespace function:parse_value variant:reference_compliant (level 2)
...
// multiple_empty_equality - feature:empty_keys feature:whitespace function:parse (level 1)
...
// key_with_newline_before_equals - feature:empty_keys feature:whitespace function:parse (level 1)
...
// complex_multi_newline_whitespace - feature:empty_keys feature:whitespace function:parse (level 1)
...
// empty_value_with_trailing_spaces_newline - feature:empty_keys feature:whitespace function:parse (level 1)
...
// empty_key_value_with_surrounding_newlines - feature:empty_keys feature:whitespace function:parse (level 1)
...
// nested_single_line - function:build_hierarchy function:parse (level 1)
...
// nested_multi_line - feature:multiline function:build_hierarchy function:parse (level 1)
...
// nested_with_blank_line - feature:multiline function:build_hierarchy function:parse_value (level 2)
...
// deep_nested_structure - function:build_hierarchy function:parse_value (level 2)
...
// ocaml_stress_test_original - feature:comments feature:empty_keys function:get_string function:build_hierarchy function:parse (level 4)
