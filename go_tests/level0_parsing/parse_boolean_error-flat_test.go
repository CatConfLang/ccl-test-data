...
// parse_boolean_error_parse - function:parse (level 0)
...
// parse_boolean_error_build_hierarchy - function:build_hierarchy (level 0)
func TestParseBooleanErrorBuildHierarchy(t *testing.T) {
	t.Skip("Test does not match run-only filter: [function:parse]")
}

// parse_boolean_error_get_bool - function:get_bool (level 0)
