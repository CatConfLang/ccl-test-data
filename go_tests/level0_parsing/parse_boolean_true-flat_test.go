...
// parse_boolean_true_parse - function:parse (level 0)
...
// parse_boolean_true_build_hierarchy - function:build_hierarchy (level 0)
func TestParseBooleanTrueBuildHierarchy(t *testing.T) {
	t.Skip("Test does not match run-only filter: [function:parse]")
}

// parse_boolean_true_get_bool - function:get_bool (level 0)
