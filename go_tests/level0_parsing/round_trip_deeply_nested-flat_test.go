...
// round_trip_deeply_nested_parse - function:parse feature:empty_keys (level 0)
...
// round_trip_deeply_nested_round_trip - function:round_trip feature:empty_keys (level 0)
