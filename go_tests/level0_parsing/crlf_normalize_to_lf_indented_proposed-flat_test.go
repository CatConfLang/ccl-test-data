...
// crlf_normalize_to_lf_indented_proposed_parse - function:parse (level 0)
...
// crlf_normalize_to_lf_indented_proposed_canonical_format - function:canonical_format (level 0)
