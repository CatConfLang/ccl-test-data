...
// mixed_dotted_and_regular_keys_parse - function:parse feature:experimental_dotted_keys (level 0)
...
// mixed_dotted_and_regular_keys_build_hierarchy - function:build_hierarchy feature:experimental_dotted_keys (level 0)
