...
// canonical_format_empty_values_canonical_format - function:canonical_format (level 0)
...
// canonical_format_unicode_canonical_format - function:canonical_format (level 0)
...
// crlf_normalize_to_lf_proposed_canonical_format - function:canonical_format behavior:crlf_normalize_to_lf (level 0)
...
// canonical_format_empty_values_ocaml_reference_canonical_format - function:canonical_format (level 0)
func TestCanonicalFormatEmptyValuesOcamlReferenceCanonicalFormat(t *testing.T) {
	t.Skip("Test does not match run-only filter: [function:parse]")
}

// canonical_format_tab_preservation_ocaml_reference_canonical_format - function:canonical_format behavior:tabs_preserve (level 0)
func TestCanonicalFormatTabPreservationOcamlReferenceCanonicalFormat(t *testing.T) {
	t.Skip("Test does not match run-only filter: [function:parse]")
}

// canonical_format_unicode_ocaml_reference_canonical_format - function:canonical_format (level 0)
...
// canonical_format_consistent_spacing_ocaml_reference_canonical_format - function:canonical_format behavior:strict_spacing (level 0)
func TestCanonicalFormatConsistentSpacingOcamlReferenceCanonicalFormat(t *testing.T) {
	t.Skip("Test does not match run-only filter: [function:parse]")
}

// deterministic_output_ocaml_reference_canonical_format - function:canonical_format (level 0)
