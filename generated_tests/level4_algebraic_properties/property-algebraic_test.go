...
// semigroup_associativity_nested - function:parse function:combine function:build-hierarchy (level 4)
...
// semigroup_associativity_lists - function:parse feature:empty-keys function:combine (level 4)
...
// monoid_left_identity_nested - function:parse function:combine function:build-hierarchy (level 4)
...
// monoid_right_identity_nested - function:parse function:combine function:build-hierarchy (level 4)
...
// monoid_left_identity_lists - function:parse feature:empty-keys function:combine (level 4)
...
// monoid_right_identity_lists - function:parse feature:empty-keys function:combine (level 4)
...
// round_trip_property_basic - function:parse function:combine function:pretty-print (level 4)
...
// round_trip_property_nested - function:parse function:combine function:build-hierarchy function:pretty-print (level 4)
...
// round_trip_property_complex - function:parse feature:empty-keys function:combine function:build-hierarchy function:pretty-print (level 4)
