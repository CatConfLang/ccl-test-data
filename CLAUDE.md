...
> [!NOTE]
> **OCaml is canonical.** The test suite tracks the OCaml reference-implementation semantics. See <https://ccl.tylerbutler.com/reference/canonical-semantics/> for the normative rule and implications; this test-data repo's fixtures follow it.
