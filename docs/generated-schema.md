...
- [4. Property `CCL Validation-Based Test Suite Schema > tests`](#tests)
  - [4.1. CCL Validation-Based Test Suite Schema > tests > validation_test_case](#tests_items)
    ...
    - [4.1.6. Property `CCL Validation-Based Test Suite Schema > tests > tests items > validations`](#tests_items_validations)
      ...
      - [4.1.6.2. Property `CCL Validation-Based Test Suite Schema > tests > tests items > validations > parse_indented`](#tests_items_validations_parse_indented)
...
| - [parse_indented](#tests_items_validations_parse_indented )           | No      | object | No         | Same as [parse](#tests_items_validations_parse )           | API: Entry processing validation (indentation-aware parsing) |
...
##### <a name="tests_items_validations_parse_indented"></a>4.1.6.2. Property `CCL Validation-Based Test Suite Schema > tests > tests items > validations > parse_indented`
